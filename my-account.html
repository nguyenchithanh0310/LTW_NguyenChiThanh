									...
									<div class="header-widget-2 text-center text-sm-end ">
										<div class="call-widget">
											<p>Liên hệ : <i class="icon ion-ios-telephone"></i><span
												class="font-weight-mid">+84-012
											345 678</span></p>
										</div>
										<ul class="header-links">
											<li><a href="login-register.html"><i class="fas fa-user"></i> Đăng nhập hoặc
												đăng ký
											</a></li>
										</ul>
									</div>
							...
							<div class="row">
								...
								<div class="col-lg-3 col-12">
									<div class="myaccount-tab-menu nav" role="tablist">
										...
										<a href="login-register.html"><i class="fas fa-sign-out-alt"></i> Đăng xuất</a>
									</div>
								</div>
													...
													<form action="#">
														<div class="row">
															<div class="col-lg-6 col-12 mb-30">
																<input id="first-name" placeholder="Họ và Tên Đệm" type="text">
															</div>
															<div class="col-lg-6 col-12 mb-30">
															...
															<div class="col-12 mb-30"><h4>Thay đổi mật khẩu</h4></div>
															<div class="col-12 mb-30">
